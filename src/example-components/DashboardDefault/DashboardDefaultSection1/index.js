            ...
            <CardContent className="p-3">
              <div className="d-flex align-items-start">
                <div className="font-weight-bold">
                  ...
                  <span className="font-size-xxl mt-1">$3,000</span>
                </div>
            ...
            <CardContent className="p-3">
              <div className="d-flex align-items-start">
                <div className="font-weight-bold">
                  ...
                  <span className="font-size-xxl mt-1">$6,000</span>
                </div>
                <div className="ml-auto">
              ...
              <div className="mt-3">
                ...
                />
                <span className="text-warning pr-1">100%</span>
            ...
            <CardContent className="p-3">
              <div className="d-flex align-items-start">
                <div className="font-weight-bold">
                  ...
                  <span className="font-size-xl mt-1">14 days</span>
                </div>
                <div className="ml-auto">
                  <div className="bg-white text-center text-primary d-50 rounded-circle d-flex align-items-center justify-content-center">
                    <FontAwesomeIcon
              ...
              <div className="mt-3">
                ...
                /> */}
                {/* <span className="text-white px-1">21st</span> */}
                <span className="text-white-50">21st NOVEMBER 2021 </span>
              </div>
            </CardContent>
          </Card>
        </Grid>
